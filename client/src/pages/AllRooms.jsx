...
const AllRooms = () => {
    ...
    // function to check if a room matches to selected roomtypes
    const matcesRoomType = (room) => {
        return (
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            {/* filters */}
            <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-6">
                <div
